...
git config --global user.name "Joaquim Bellmunt"
git config --global user.email "joaquim.bell@gmail.com  "
ssh-keygen -t rsa -N "" -C "joaquim.bell@gmail.com" -f ~/.ssh/id_rsa
ssh-add .ssh/id_rsa
